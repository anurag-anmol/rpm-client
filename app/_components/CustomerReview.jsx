    ...
    return (
        <section className="py-20 px-4 relative overflow-hidden">
            <div className="container mx-auto">
                {/* Header with avatars and star rating */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 mt-10">
                    <h2 className="text-4xl md:text-5xl mb-6 md:mb-0 ml-4">
                        Customer{' '}
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div className="flex -space-x-3">
                            ...
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gray-400"></div>
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gray-500"></div>
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gray-600"></div>
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gray-700 flex items-center justify-center text-white text-sm sm:text-base">
                                34+
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-start sm:items-start">
                            <img
                                src="https://cdn.prod.website-files.com/68149cfdae7cc5226d0569ac/681b4893b4fda30d5a815c34_star.svg"
                                loading="lazy"
                                alt="Star"
                                className="w-20 h-5"
                            />
                ...
                {/* Testimonials Marquee */}
                <div className="relative lg:overflow-hidden animate-scroll flex whitespace-wrap overflow-x-auto py-8">
                    <div className="flex space-x-6 min-w-max">
                        ...
                        {[...Array(4)].map((_, i) => {
                            ...
                            return (
                                <div
                                    key={i}
                                    className="w-[320px] sm:w-96 bg-[#16162b] text-white p-6 sm:p-8 rounded-xl relative overflow-hidden shrink-0"
                                >
                                    <div className="absolute top-0 left-0 w-32 h-32 rounded-full bg-[#39263a] opacity-20 -translate-x-1/2 -translate-y-1/2"></div>
                                    <div className="absolute bottom-0 right-0 w-40 h-40 rounded-full bg-[#39263a] opacity-40 translate-x-1/2 translate-y-1/2"></div>

                                    <img
                                        src="https://cdn.prod.website-files.com/68149cfdae7cc5226d0569ac/681b73c6e2b2918f05d617f5_star-white.svg"
                                        alt="Star"
                                        className="w-20 h-5 mb-4"
                                    />

                                    <blockquote className="text-lg sm:text-xl font-medium mb-6 leading-snug">
                                        “{testimonial.quote}„
                                    </blockquote>

                                    <div className="flex items-center">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gray-300 mr-4"></div>
                                        <div>
