...
function Work() {
    return (
        <section className="relative py-20 px-4 overflow-hidden dark:bg-[#0c0c1d]">
            <div className="container mx-auto">
                {/* Header */}
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold">
                    ...
                    <div className="mt-12 flex justify-center">
                        <a href="/" className="group  items-center cursor-pointer">
                            <span className="mr-2 font-bold text-2xl text-muted-foreground">view all work</span>
                            <div className="w-5 h-px bg-white group-hover:w-37 transition-all duration-300"></div>
                        </a>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    {[
                        {
                            logo: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a1f519748296471299501_logo-1.avif",
                            image: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a21a57bb122a438b3d1d5_work-2.avif",
                            title: "Clicks and Magic",
                            tags: "Web Design, Marketing"
                        },
                        {
                            logo: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a1d23ba6ba04766e4b996_logoipsum-372.svg",
                            image: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a10cfe46dc96cac217cc7_Silhouetted%20Hands%20with%20Gradient%20Tablet.avif",
                            title: "Design Depth",
                            tags: "Concept, Web Design"
                        },
                        {
                            logo: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a1db4646871985ea4b500_logoipsum-352.svg",
                            image: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a1b54d571e0efde8f9c67_Focused%20Athlete%20Profile%20(2).avif",
                            title: "Digital Direction",
                            tags: "Strategy, Web Design, Marketing"
                        },
                        {
                            logo: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a202b96dbee5f08616dfb_logo-2.avif",
                            image: "https://cdn.prod.website-files.com/68149cfdae7cc5226d0569bd/681a2226e6b380d91856b922_work-1.avif",
                            title: "Studio Focus",
                            tags: "Web Design, Marketing"
                        }
                    ].map((project, idx) => (
                        <a key={idx} href="/" className="group block relative overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                            {/* Image Container */}
                            <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                                <img
                                    src={project.image}
                                    alt="project"
                                    className="absolute inset-0 w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500 filter group-hover:blur-sm"
                                />
                                <div className="absolute inset-0 flex items-center justify-center z-10">
                                    <img
                                        src={project.logo}
                                        alt="logo"
                                        className="w-20 h-20 object-contain transform group-hover:scale-90 transition-transform duration-500"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="mt-6 flex items-start justify-between px-2">
                                <div>
                                    ...
                                    <div className="relative w-16 h-px bg-black mt-3 overflow-hidden">
                                        <div className="absolute top-0 left-0 w-full h-full bg-white transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500"></div>
                                    </div>
                                </div>
                                <p className="text-sm text-muted-foreground mt-1 text-right">{project.tags}</p>
                            </div>
                        </a>
                    ))}
